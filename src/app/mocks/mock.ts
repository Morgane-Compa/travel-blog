...
export const ARTICLES : Article[] = [
  {
    ...
    negatif : ["Attention, si vous êtes humain ne vous promenez pas en pleine nuis sur la plaine, vous risquez de vous faire manger par les orcs qui sont de chasse", "ne vous approchez pas de la poudre de fatae, vous pourriez devenir rapidement accro à cette puissante drogue", "La foire se passe en été, veillez à vous protéger du soleil"],
